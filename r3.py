...
#                 # Store data in MongoDB regardless of success
#                 current_week = isoweek.Week.thisweek()
#                 current_week = f"{current_week.year}-W{current_week.week:02d}"
#                 player_data = {
#                     "school": school_name,
#                     "division": sheet_name,
#                     "url": url,
#                     "rosterYear": result.get('rosterYear', None),  # Use get to handle potential KeyError
#                     "players": result.get('players', []),  # Use get to handle potential KeyError
#                     "timestamp": datetime.now(),
